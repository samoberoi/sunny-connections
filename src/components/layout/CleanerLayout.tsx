        ...
        <div className="glass-card-elevated border-t-0 rounded-t-2xl">
          <div className="flex justify-around items-center h-20 max-w-lg mx-auto px-2">
            {navItems.map(({ to, icon: Icon, label }) => {
              ...
              return (
                <Link key={to} to={to} className={`flex flex-col items-center gap-1 py-2 px-4 rounded-2xl transition-all ${active ? 'text-primary' : 'text-muted-foreground hover:text-foreground'}`}>
