...
const ratingDist = [
  { name: '5 stars', value: 65 }, { name: '4 stars', value: 22 }, { name: '3 stars', value: 8 },
  { name: '2 stars', value: 3 }, { name: '1 star', value: 2 },
];
const COLORS = ['hsl(130,50%,30%)', 'hsl(130,40%,45%)', 'hsl(42,90%,55%)', 'hsl(42,60%,65%)', 'hsl(0,60%,55%)'];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="glass-card rounded-xl p-5">
          ...
          <ResponsiveContainer width="100%" height={220}>
            <BarChart data={revenueData}><XAxis dataKey="month" /><YAxis /><Tooltip /><Bar dataKey="revenue" fill="hsl(130,50%,30%)" radius={[4,4,0,0]} /></BarChart>
          </ResponsiveContainer>
        </div>

        <div className="glass-card rounded-xl p-5">
          <h3 className="font-display font-semibold text-foreground mb-4">Booking Volume</h3>
          <ResponsiveContainer width="100%" height={220}>
            <LineChart data={bookingVolume}><XAxis dataKey="month" /><YAxis /><Tooltip /><Line type="monotone" dataKey="bookings" stroke="hsl(42,90%,55%)" strokeWidth={2} /></LineChart>
          </ResponsiveContainer>
        </div>
