      ...
      <PageTransition>
        <div className="px-5 pt-6 pb-6">
          <div className="flex items-center gap-3 mb-6">
            <BackButton />
            <h1 className="text-xl font-display font-black text-foreground">My Profile</h1>
          </div>
          ...
          {cleaner && (
            <>
              <div className="border border-border rounded-2xl p-5 mb-4">
                <h3 className="font-display font-semibold text-foreground mb-3 text-sm">Specialisations</h3>
                <div className="flex flex-wrap gap-2">
                  {cleaner.specialisations.map((s: string) => (
                    <Badge key={s} className="bg-muted text-foreground rounded-xl px-3 py-1 text-xs font-medium border-0">{s}</Badge>
                  ))}
                </div>
              </div>

              <div className="border border-border rounded-2xl p-5 mb-6 flex items-center gap-3">
                <Shield className="h-5 w-5 text-foreground" strokeWidth={1.5} />
                <div>
                  <h3 className="font-semibold text-foreground text-sm">Verified & DBS Checked</h3>
