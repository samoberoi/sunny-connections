...
export default function CleanerJobs() {
  ...
  // Show every upcoming instance individually so cleaners see their full schedule
  // (next week, week after, etc.). Recurring bookings are NOT collapsed here.
  const upcomingFuture = upcomingFutureRaw;
