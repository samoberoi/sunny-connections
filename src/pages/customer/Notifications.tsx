      ...
      <div className="px-5 pt-6 pb-6">
        ...
        <div className="space-y-3">
          {notifications.map(n => {
            ...
            return (
              <div key={n.id} className={`glass-card rounded-2xl p-4 flex gap-3 shadow-apple ${!n.read ? 'border-l-4 border-l-primary' : ''}`}>
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground/50 mt-1">{new Date(n.createdAt).toLocaleDateString('en-GB')}</p>
                </div>
              </div>
            );
          })}
