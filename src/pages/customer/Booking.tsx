          ...
          <div className="space-y-6">
            ...
            <section>
              <h3 className="font-bold text-foreground mb-3 flex items-center gap-2 text-sm">
                <Home className="h-4 w-4 text-primary" strokeWidth={1.5} /> Property Type
              </h3>
              <div className="grid grid-cols-3 gap-2">
                {propertyTypes.map(pt => (
                  <motion.button
                    ...
                    className={`py-4 rounded-xl text-sm font-medium transition-all duration-200 flex flex-col items-center gap-2 ${
                      propertyType === pt.value ? 'gradient-blue text-primary-foreground shadow-blue/30' : 'bg-muted text-muted-foreground'
                    }`}
                  >
            ...
            <section>
              <h3 className="font-bold text-foreground mb-3 flex items-center gap-2 text-sm">
                <StickyNote className="h-4 w-4 text-primary" strokeWidth={1.5} /> Special Instructions
              </h3>
            ...
            <Button
              ...
              className="w-full h-14 text-base font-semibold gradient-blue text-primary-foreground rounded-2xl shadow-blue transition-opacity hover:opacity-95 disabled:opacity-50"
            >
